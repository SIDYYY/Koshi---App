...
export default function CarLoanCalculator() {
  ...
  return (
    <Container>
      <Text className="text-2xl font-bold text-black text-center my-16">Car Loan Calculator</Text>
      ...
      >
        <Text className="text-white text-lg font-bold text-center">Calculate</Text>
      </TouchableOpacity>
