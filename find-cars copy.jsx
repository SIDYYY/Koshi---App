...
const FindCars = () => {
  ...
  return (
    <Container>
      ...
      <TouchableOpacity
        className="bg-green_primary p-2.5 rounded-3xl text-center my-3 w-32"
      ...
      {showFilters && (
        <View className="my-1.5 ">
          ...
          <TouchableOpacity
            className="bg-green_primary p-2 rounded-md mt-3"
      ...
      >
        {filteredCarModels.length > 0 ? (
          filteredCarModels.map((carModel) => (
            ...
            >
              <Image
                source={{ uri: carModel.image }}
                className="w-11 mr-5 rounded-lg"
              />
              <View className="my-2.5 flex-1">
                ...
                <TouchableOpacity
                  ...
                  onPress={() => handleCarSelect(carModel)}
                >
                  <Text className="text-sm font-pbold text-center">
                    View Detail
                  </Text>
                </TouchableOpacity>
              </View>
